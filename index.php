...
<body id="top">
    ...
    <a class="logo" href="index.php">
        <img src="images/lia.png" alt="Homepage" style="width: 200px; height: 200px;">
    </a>
</div>
            ...
            <div class="row s-intro__content">
                <div class="column lg-12">
                    ...
                    <div class="s-intro__content-top">
                        ...
                        <p class="">
                        kami akan mengerjakan sesuatu yang luar biasa, tunggu saja!
                        </p>
                    </div> <!-- end s-intro__content-top --> 

                    <div class="s-intro__content-sep">
                        <span></span>
                        <span> <a href="signin.php">Get Started</span> </a>
                        <span></span>
        ...
        <section id="about" class="s-about">
            ...
            <div class="row section-header">
                <div class="column lg-12 ss-animate ss-fade-up">
                    ...
                    <p class="lead">
                        Website ini dikerjakan dalam waktu 1 hari 1 malam jadi nikmatilah hasilnya walau tidak seindah surga.
                    </p>
                </div>
